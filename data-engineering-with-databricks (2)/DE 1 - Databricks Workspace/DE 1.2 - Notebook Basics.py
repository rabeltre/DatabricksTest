...
spark.conf.set("spark.sql.test", 'Maria lava la ropa')
...
test = 'Esto es una prueba con Variable'
print(f"DA:                   {filter_value}")

# COMMAND ----------

dbutils.widgets.text("filter_value", "lola")

# COMMAND ----------

# MAGIC %sql
# MAGIC select '${filter_value}' as test
